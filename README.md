...
- **真港幣記帳（M5）**：底欄「牧場｜入帳｜帳簿｜日記」；金額 `amountMinor`（港幣分）；分類／帳戶 stub；可編輯、作廢
- **每日結算**：有記（有效帳或無交易日）即可結算，**固定 1 成長點＋1 種子幣／本地日一次**；編輯唔會再次發獎；金額／筆數唔影響獎勵
...
- **農田／背包（M2）**：種／澆／收用背包種子與收成堆疊
- **夜結／餵食（M3）**：夜晚結算儀式 UX（仍一日一點）；寵物餵食改耗背包飼料，開心／進食反饋
- **一日生活（M4）**：起床→勞作→黃昏商店→夜結→瞓覺過日；場景商店攤位；安家／旺場佈置耗成長點（唔發獎）
- **拆混帳（M5）**：商店買種子／賣菜／買飼料只動**種子幣／背包**，**唔寫**真港幣 `ledger_entries`；入帳極速流＋跨日帳簿搜尋＋日記殼
...
- 未做多語系切換（目前固定繁中）
- 多帳戶／轉帳 UI／預算／圖表／完整日記編輯器留後續里程碑（帳戶 stub「現金」已備）
